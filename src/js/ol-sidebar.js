...
e2molin:
(1).- Al poner la clase hotlink al elemento <li>, permite ejecutar una función sin desplegar el panel. Útil para mostrar un modal con un botón desde la sidebar
*/
...
ol.control.Sidebar = function (settings) {
    ...
    //El método assign deObject no le gusta a IE, hay que comentarlo y definir los parámetros a pelo
...
ol.control.Sidebar.prototype._onClick = function() {
    if (this.classList.contains('active')) {
        this._sidebar.close();
    } else if (this.classList.contains('hotLink')) {
        //e2molin:(1)
        console.log("Lanzar hotLink");
        this._sidebar.close();

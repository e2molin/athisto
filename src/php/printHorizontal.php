...
$imgNorth = "urlService=".$servidorWMS[0]."&SERVICES=WMS&VERSION=1.3.0&REQUEST=GetMap&LAYERS=".$layer[0]."&FORMAT=image/jpeg&CRS=EPSG:3857".$BBOX."&WIDTH=".$ancho."&HEIGHT=".$alto;
$imgSouth = "urlService=".$servidorWMS[1]."&SERVICES=WMS&VERSION=1.3.0&REQUEST=GetMap&LAYERS=".$layer[1]."&FORMAT=image/jpeg&CRS=EPSG:3857".$BBOX."&WIDTH=".$ancho."&HEIGHT=".$alto;
